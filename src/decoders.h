...
extern SYS_FUNC(afs_syscall);
extern SYS_FUNC(alarm);
extern SYS_FUNC(arch_prctl);
extern SYS_FUNC(bdflush);
extern SYS_FUNC(bind);
extern SYS_FUNC(bpf);
extern SYS_FUNC(break);
extern SYS_FUNC(brk);
...
extern SYS_FUNC(clock_getres_time32);
extern SYS_FUNC(clock_getres_time64);
...
extern SYS_FUNC(get_kernel_syms);
...
extern SYS_FUNC(gtty);
extern SYS_FUNC(idle);
...
extern SYS_FUNC(nfsservctl);
extern SYS_FUNC(nice);
extern SYS_FUNC(oldfstat);
extern SYS_FUNC(oldlstat);
extern SYS_FUNC(old_mmap);
extern SYS_FUNC(oldolduname);
...
extern SYS_FUNC(prof);
extern SYS_FUNC(profil);
...
extern SYS_FUNC(tuxcall);
extern SYS_FUNC(ulimit);
...
extern SYS_FUNC(vm86);
extern SYS_FUNC(vm86old);
extern SYS_FUNC(vmsplice);
extern SYS_FUNC(vserver);
